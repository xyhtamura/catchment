...
hardware as [deskarium](../../deskarium/rpi/README.md), and the key map is
...
[`deskarium-server.service`](../../deskarium/rpi/deskarium-server.service) — the
...
[`deskarium-kiosk.sh`](../../deskarium/rpi/deskarium-kiosk.sh) does it.
